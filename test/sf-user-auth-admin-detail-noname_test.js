...
suite('sf-user-auth > Admin tests', () => {
    ...
    test('admin tests', async () => {
        stub(Util, 'callApi').returns(new Promise((resolve) => {
            resolve({ status: 200, responseText: JSON.stringify({ "result": true, "data": { "values": { "refreshTokens": [{ "M": { "token": { "S": "lf6dz4u271g8bunsjs4" }, "expiry": { "S": "1681277452361" } } }, { "M": { "token": { "S": "lf6dz5xg8ur5u7t41uq" }, "expiry": { "S": "1681277453764" } } }], "admin": true, "otp": [], "accessTokens": [{ "M": { "token": { "S": "lf6dz5xgikzz5rkk0vr" }, "expiry": { "S": "1679290253764" } } }], "email": "hrushi.mehendale@gmail.com", "name": null, "otpTime": "1678685424001", "reason": "test reason" } } }) });
        }));
...
//# sourceMappingURL=sf-user-auth-admin-detail-noname_test.js.map