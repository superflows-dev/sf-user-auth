...
suite('sf-user-auth > Admin tests', () => {
    ...
    test('admin tests', async () => {
        ...
        const locked = el.shadowRoot.querySelectorAll('#locked')[0];
        ...
        const unlocked = el.shadowRoot.querySelectorAll('#unlocked')[0];
...
//# sourceMappingURL=sf-user-auth-admin-detail_test.js.map