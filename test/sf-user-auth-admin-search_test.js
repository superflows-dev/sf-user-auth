...
suite('sf-user-auth > Admin tests', () => {
    ...
    test('refresh tests', async () => {
        ...
        const submit = el.shadowRoot.querySelectorAll('.submit-search')[0];
        assert.ok(submit.outerHTML.indexOf('disabled') > 0);
        const ipSearch = el.shadowRoot.querySelectorAll('.input-search')[0];
...
//# sourceMappingURL=sf-user-auth-admin-search_test.js.map