...
suite('sf-user-auth > Basic tests', () => {
    ...
    test('sign up render error', async () => {
        ...
        const ipName = el.shadowRoot.querySelectorAll('#name')[0];
        ...
        const ipEmail = el.shadowRoot.querySelectorAll('#email')[0];
        ...
        const ipTerms = el.shadowRoot.querySelectorAll('#terms')[0];
        ipTerms.checked = true;
        await new Promise((r) => setTimeout(r, TIMEOUT));
        const ipPrivacy = el.shadowRoot.querySelectorAll('#privacy')[0];
        ...
        await new Promise((r) => setTimeout(r, TIMEOUT));
        const divRowError = el.shadowRoot.querySelectorAll('.div-row-error-message')[0];
        assert.ok(divRowError.innerHTML.indexOf('already exists') >= 0);
    });
});
//# sourceMappingURL=sf-user-auth_test.js.map
//# sourceMappingURL=sf-user-auth-signup-error_test.js.map